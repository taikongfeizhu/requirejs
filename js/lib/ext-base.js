...
(function () {
    ...
    Ext.lib.Event = function () {
        ...
        var x = {extAdapter:true, onAvailable:function (H, F, I, G) {
    ...
    Ext.lib.Ajax = function () {
        ...
        function p(u, y) {
            ...
            return{tId:u.tId, status:v ? 204 : w.status, statusText:v ? "No Content" : w.statusText, getResponseHeader:function (s) {
        ...
        var k = {request:function (s, u, v, w, A) {
            if (A) {
        ...
        }, useDefaultHeader:true, defaultPostHeader:"application/x-www-form-urlencoded; charset=UTF-8", useDefaultXhrHeader:true, defaultXhrHeader:"XMLHttpRequest", poll:{}, timeout:{}, conn:{}, pollInterval:50, transactionId:0, abort:function (v, x, s) {
    ...
    (function () {
        ...
        (function () {
            ...
            Ext.apply(g.Motion.prototype, {setAttr:function (n, r, q) {
